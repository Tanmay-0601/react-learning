 ...
 const convert=()=>{
  ...
  <>
    <div
      ...
      justify-center items-center gap-3 bg-cover bg-no-repeat"
      style={{
    ...
    <div className="w-full">
      <div className="w-full max-w-md mx-auto
        border border-gray-400 rounded-lg shadow-md p-4 
        ...
        "
               ...
               <button type ="submit"
                ...
                py-3 rounded-lg">Convert {from.toUpperCase() } to {to.toUpperCase()}</button>
